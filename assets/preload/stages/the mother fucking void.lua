function onCreate()
	-- background shit
	makeLuaSprite('the mother fucking void', 'the mother fucking void', -600, -350);
	setScrollFactor('the mother fucking void', 0.9, 0.9);
	...
	addLuaSprite('the mother fucking void', false);
