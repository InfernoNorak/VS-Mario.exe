...
class FreeplayCategory extends MusicBeatState{
    var freeplayCats:Array<String> = ['Ink Mario', 'Liver stealer', 'Freeplay songs'];
    ...
    override public function update(elapsed:Float){
        ...
        if (controls.ACCEPT){
            switch(curSelected){
                case 0:
                MusicBeatState.switchState(new InkMarioFreeplayState());
                case 1:
                MusicBeatState.switchState(new LiverFreeplayState());
                case 2:
                MusicBeatState.switchState(new FreeplaySongsState());
            }
        }
