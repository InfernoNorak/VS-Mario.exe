...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		MarioLogo = new FlxSprite().loadGraphic(Paths.image('titleMenu/titleLogo'));
		MarioLogo.screenCenter();
		MarioLogo.offset.y += 60;
		MarioLogo.antialiasing = ClientPrefs.globalAntialiasing;
		MarioLogo.screenCenter();
