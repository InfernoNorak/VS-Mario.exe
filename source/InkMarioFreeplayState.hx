...
class InkMarioFreeplayState extends MusicBeatState{
	...
	{
		addSong('on edge', 4, 'mario', FlxColor.GREEN);
		addSong('heart beat', 4, 'preink', FlxColor.GREEN);
        addSong('enslaved', 4, 'ink', FlxColor.GREEN);
